...
var $e = document.querySelector("home-assistant") && !customElements.get("home-assistant") ? customElements.whenDefined("home-assistant") : Promise.resolve(), et = (e) => void $e.then(e);
function U(e, t) {
	et(() => {
...
var nt = /* @__PURE__ */ new Set(["zone_open", "zone_fault"]);
U("foyer-page-overview", class extends A {
	constructor(...e) {
		...
		if (n) {
			...
			try {
				...
				if (r.reason === "cancelled") this._feedback = {
					...
					retry: t && nt.has(r.reason ?? "") ? t : void 0
				};
			} catch (e) {
				this._feedback = {
					ok: !1,
...
var { I: rt } = je, it = (e) => e.strings === void 0, at = {}, ot = (e, t = at) => e._$AH = t, W = Ie(class extends Le {
	constructor(e) {
		...
		if (!it(e)) throw Error("`live` bindings can only contain a single expression");
	}
	render(e) {
		return e;
	}
...
function st(e, t, n, r) {
    ...
    >
      <option value="" .selected=${W(n === null)}>${M(e, "code_policy.inherit")}</option>
      <option value="yes" .selected=${W(n === !0)}>${M(e, "code_policy.required")}</option>
      <option value="no" .selected=${W(n === !1)}>${M(e, "code_policy.not_required")}</option>
    </select>
  </label>`;
}
function ct(e, t, n, r) {
	return C`
    ${st(e, "field.require_code_to_arm", t.require_code_to_arm, (e) => n("require_code_to_arm", e))}
    ${st(e, "field.require_code_to_disarm", t.require_code_to_disarm, (e) => n("require_code_to_disarm", e))}
    <p class="hint span">
...
U("foyer-delete-button", class extends A {
	constructor(...e) {
...
function G(e, t, n, r) {
    ...
    <select @change=${(e) => n(e.target.value || null)}>
      <option value="" .selected=${W(!t)}>${M(i, "profiles.inherit")}</option>
...
function ut(e, t) {
	...
	let n = e.status?.areas.find((e) => e.id === t)?.scenario_id ?? null, { name: r, source: i } = lt(e.config, t, n), a = e.strings;
...
U("foyer-page-areas", class extends A {
	constructor(...e) {
	...
	_edit(e) {
		...
		this._draft = e ? { ...e } : {
			...dt,
			default_entry_delay: t?.default_entry_delay ?? dt.default_entry_delay,
			default_exit_delay: t?.default_exit_delay ?? dt.default_exit_delay
      ...
      <div class="card editor">
        ...
        <div class="card-bd">
          <div class="grid-form">
            ...
            ${ct(e, t, (e, t) => this._set(e, t), this.ctx.status.security.enforced)}
          </div>
          <label class="check">
            <input
              type="checkbox"
...
var Ct = (e, t) => JSON.stringify(e) === JSON.stringify(t);
U("foyer-page-zones", class extends A {
	constructor(...e) {
 ...
 @keydown=${B}
	...
	_renderEntityPicker(e, t) {
      ...
      <div class="grid-form">
        ...
        <label class="field">
          ...
          >
            <option value="" .selected=${W(!t.entity_id)}>${M(e, "zones.pick_entity")}</option>
            ${o.map((n) => C`<option
                .value=${n.entity_id}
	...
	_renderEventTrigger(e, t, n) {
      ...
      <label class="field">
        ...
        >
          <option value="" .selected=${W(!r)}>${M(e, "zones.pick_event")}</option>
    ...
    `;
      ...
      <fieldset>
        ...
        ${G(n, t.response_profile_id, (e) => this._set("response_profile_id", e), M(e, "profiles.zone_hint"))}
...
U("foyer-page-scenarios", class extends A {
	constructor(...e) {
		super(...e), this._problems = [], this._busy = !1;
	}
	static {
	...
	async _delete() {
		if (this.ctx && this._draft?.id) {
			...
			try {
				...
				this._problems = Qe(this.ctx.strings, this.ctx.config, e.problems), e.success && (this._draft = void 0);
			} finally {
				this._busy = !1;
			}
		}
      ...
      <div class="card editor">
        ...
        <div class="card-bd">
          <div class="grid-form">
            ...
            ${G(this.ctx, t.response_profile_id, (e) => this._set("response_profile_id", e))}
            ${ct(e, t, (e, t) => this._set(e, t), n.status.security.enforced)}
          </div>
          <fieldset>
...
function kt(e) {
	...
	return typeof t == "string" && Dt.includes(t) ? t : e.params.camera_entity_id ? "fixed" : "none";
}
var At = ["notify", "persistent_notification"], jt = [
	"siren",
	"light",
	"switch"
], Mt = [
...
U("foyer-page-profiles", class extends A {
	constructor(...e) {
	...
	_fromTemplate(e) {
		let t = this._templateContacts.map((e) => ({
			contact_id: e,
			channel_id: null
		})), n = Pt.map(({ key: n, moments: r, images: i }) => {
			let a = Nt("notify");
			return {
				...a,
	...
	_addAction(e) {
		this._draft && (this._draft = {
			...this._draft,
			actions: [...this._draft.actions, Nt(e)]
 ...
 @keydown=${B}
	...
	_renderEscalation(e, t, n) {
		...
		if (!At.includes(t.kind)) return T;
	...
	_renderParams(e, t, n) {
		...
		switch (jt.includes(t.kind) && a.push(this._picker(e, t, n, "entity_ids", r, !0)), Mt.includes(t.kind) && a.push(this._picker(e, t, n, "entity_id", r, !1)), t.kind) {
			case "notify":
				a.push(this._renderContacts(e, t, n)), Ft(t).length || a.push(this._suggested(e, t, n, "service", q(this.ctx.hass), M(e, "profiles.notify_hint"))), a.push(this._text(e, t, n, "title")), a.push(this._text(e, t, n, "message", i)), a.push(this._renderImages(e, t, n)), (kt(t) === "zone" || kt(t) === "fixed" && t.params.camera_entity_id) && (a.push(this._select(e, t, n, "attachment", Et, (t) => M(e, `attachment.${t}`))), a.push(C`<span class="hint"
	...
	_renderImages(e, t, n) {
		let r = kt(t), i = t.moments.filter((e) => !Ot.includes(e));
		return C`<label class="field">
        ...
        >
          ${Dt.map((t) => C`<option .value=${t} .selected=${W(t === r)}>
                ${M(e, `images.${t}`)}
              </option>`)}
        </select>
      ...
      ${r === "zone" && i.length ? C`<span class="hint wide"
          ...
          >` : T}
      ${r === "zone" && Ft(t).length ? C`<span class="hint wide">${M(e, "profiles.images_channels")}</span>` : T}`;
	}
	_select(e, t, n, r, i, a) {
		return C`<label class="field">
      <span class="lbl">${M(e, `field.${r}`)}</span>
	...
	_renderMoments(e, t, n) {
      ...
      ${Object.entries(Tt).map(([a, o]) => C`<fieldset>
...
}), U("foyer-page-groups", class extends A {
	constructor(...e) {
		super(...e), this._problems = [], this._busy = !1;
	}
	static {
      ...
      <div class="card editor">
        ...
        <div class="card-bd">
          <div class="grid-form">
            ...
            ${G(this.ctx, t.response_profile_id, (e) => this._set("response_profile_id", e), M(e, "profiles.group_hint"))}
          </div>
          <fieldset>
...
U("foyer-page-users", class extends A {
	constructor(...e) {
	...
	_edit(e) {
		this._busy || (this._draft = e ? { ...structuredClone(e) } : structuredClone(It), this._problems = [], L(this));
	}
	_set(e, t) {
		this._draft &&= {
			...this._draft,
        ...
        <div class="card-bd">
          <div class="grid-form">
            ...
            <label class="field">
              ...
              >
                <option value="" .selected=${W(!t.ha_user_id)}>${M(e, "users.not_linked")}</option>
            ...
            <label class="field">
              ...
              <input
                type="datetime-local"
                .value=${Lt(t.valid_from)}
                @input=${(e) => this._set("valid_from", Rt(e.target.value))}
              />
            </label>
            <label class="field">
              ...
              <input
                type="datetime-local"
                .value=${Lt(t.valid_until)}
                @input=${(e) => this._set("valid_until", Rt(e.target.value))}
              />
...
var Bt = [
	...
	transport: "mqtt",
	...zt()
}, Gt = ["tag.", "event."], Kt = class extends A {
	constructor(...e) {
	...
	_edit(e) {
		this._busy || (this._draft = e ? {
			...zt(),
			...structuredClone(e)
		} : structuredClone(Wt), this._problems = [], this._token = void 0, this._tokenProblems = [], this._confirmToken = void 0, L(this));
	}
 ...
 @keydown=${B}
	...
	_tagEntities(e) {
		return this._tagCache?.states !== e && (this._tagCache = {
			states: e,
			ids: Object.keys(e).filter((e) => Gt.some((t) => e.startsWith(t))).sort()
		}), this._tagCache.ids;
	}
	_inClear(e) {
	...
	_renderScopes(e, t) {
		let n = this.ctx?.config, r = (e) => t.scopes.includes(e), i = t.scopes.some((e) => e !== "status"), a = Bt.some((e) => r(e) && !t.free_scopes.includes(e)), o = (n?.areas ?? []).map((e) => ({
			id: e.id ?? "",
			name: e.name
		})), s = (n?.scenarios ?? []).map((e) => ({
			id: e.id ?? "",
      ...
      ${Bt.map((n) => C`<div class="scope-row">
          <label class="check">
            <input
              type="checkbox"
              .checked=${W(r(n))}
        ...
        <div class="card-bd">
          ...
          <div class="grid-form">
            ...
            <div class="field">
              ...
              <pre class="sample">${Xt[t.detail]}</pre>
...
var tn = class extends A {
	...
	_renderOverrides(e) {
      ...
      <fieldset>
        ...
        ${this._overrides.map((n, r) => C`
			...
			state: $t(t, e.target.value)[0] ?? n.state
		})}
              >
              ...
              <datalist id="foyer-sim-states-${r}">
                ${$t(t, n.zone_id).map((e) => C`<option .value=${e}></option>`)}
              </datalist>
              <input
                class="at-input"
                type="number"
	...
	_renderBatches(e, t) {
		return C`${t.batches.filter((e) => e.actions.length > 0 || Qt.has(e.moment)).map((t) => this._renderBatch(e, t))}`;
	}
	_renderBatch(e, t) {
	...
	async _runTest(e) {
		...
		if (t) {
			...
			try {
				...
				}), r = n.error ?? nn(t.strings, n.reason);
				this._tested = {
					...this._tested,
...
U("foyer-page-contacts", class extends A {
	constructor(...e) {
	...
	_addChannel() {
		this._draft &&= {
			...this._draft,
			channels: [...this._draft.channels, structuredClone(on)]
		};
	}
	_removeChannel(e) {
		this._draft &&= {
		...
		if (this.ctx && e.id && t.id) {
			...
			try {
				...
				this._tested = {
					...
					[t.id]: {
						ok: n.success,
						error: n.error ?? nn(this.ctx.strings, n.reason ?? null)
					}
				};
			} catch (e) {
				this._tested = {
	...
	async _copyWebhook() {
		...
		e && (this._copied = await rn(this.renderRoot, e));
	}
	render() {
		let e = this.ctx;
		if (!e?.config) return T;
 ...
 @keydown=${B}
	...
	_renderPolicies(e) {
		let t = this.ctx, n = t.config?.contacts ?? [], r = cn(t.config?.profiles ?? []);
		return C`
      <div class="card">
        <div class="card-hd">
...
U("foyer-page-rules", class extends A {
	constructor(...e) {
          ...
          ${t.length ? C`<div class="stack">
                ${t.map((t) => C`<div class="suspension">
                    <div>
                      ...
                      <div class="hint mono">
                        ${t.kind === "next" ? M(e, "rules.suspension_next_hint") : `${mn(t.start, n.hass.language)} – ${mn(t.until, n.hass.language)}`}
...
var X = 50, gn = class extends A {
 ...
 @keydown=${B} aria-selected=${a ? "true" : "false"} @click=${() => this._open = a ? void 0 : t.id}>
        ...
        <td>
          <span class="state ${yn(t.severity)}">
            ${_n(e, t.event_type)}
          </span>
        </td>
        ...
        <td>${o}</td>
        <td>
          ${t.user_name ?? (t.channel ? vn(e, t.channel) : "")}
...
U("foyer-page-settings", class extends A {
	constructor(...e) {
	...
	get _chime() {
		return this._draft ?? structuredClone(this.ctx?.config?.chime ?? xn);
	}
	_set(e, t) {
		this._draft = {
			...this._chime,
          ...
          ${this._confirmPseudonymise ? C`<div class="problems" role="alert">
                ...
                <div class="actions">
                  <button
                    class="btn danger"
                    @click=${() => {
			this._confirmPseudonymise = !1, o({ pseudonymise_after: bn });
		}}
                  >
	...
	_renderResponse(e) {
        ...
        >
          <option value="" .selected=${W(!n[t])}>${M(e, "settings.none")}</option>
...
U("foyer-page-health", class extends A {
	constructor(...e) {
            ...
            <table>
              ...
              <tbody>
                ${t.channels.map((t) => C`<tr>
                    ...
                    <td>${Sn(this.ctx, t.since ?? t.last_ok)}</td>
                  </tr>`)}
              </tbody>
            </table>
	...
	_renderStartupGrace(e, t) {
		...
		return C`<div class="grid-form">
      <label class="field">
        <span class="lbl">${M(e, "field.startup_grace")}</span>
        <input
          type="number"
          min=${n}
          max=${r}
          .value=${String(t.startup_grace ?? 120)}
          @input=${(e) => V(e, (e) => this._set("startup_grace", e))}
        />
        <span class="hint">${M(e, "health.startup_grace_hint")}</span>
      </label>
    </div>`;
	}
	_renderEditor(e, t) {
...
}), U("foyer-page-api", class extends A {
	constructor(...e) {
...
U("foyer-wizard", class extends A {
	constructor(...e) {
	...
	_renderZones(e) {
      ...
      <div class="grid-form">
        <label class="field">
          ...
          >
            <option value="" .selected=${W(!this._pickedEntity)}>${M(e, "wizard.pick_entity")}</option>
	...
	_renderTest(e) {
      ...
      <div class="grid-form">
        <label class="field">
          ...
          >
            <option value="" .selected=${W(!this._notifyTarget)}>${M(e, "wizard.pick_target")}</option>
	...
	_renderLeft(e) {
		...
		return n.zones.length < Cn && r.push({
...
}, Dn = "https://github.com/foyer-labs/Foyer-Home-Defender/blob/master/docs", On = {
...
function An(e, t) {
	...
	return `${Dn}/${kn[a]?.has(r) ? r.replace(/\.md$/, `.${a}.md`) : r}${i ? `#${i}` : ""}`;
}
var jn = 12e4;
function Mn(e) {
	let t = {
...
U("foyer-panel", class extends A {
	...
	_rememberCode(e) {
		this._code = e, window.clearTimeout(this._codeTimer), this._codeTimer = window.setTimeout(() => this._forgetCode(), jn);
	}
	_forgetCode() {
    ...
    `;
      ...
      <nav class="tabs" role="tablist">
        ...
        ${Tn.map(t)} ${this._isAdmin ? t("api") : T}
      </nav>
    ` : C`<nav class="tabs" role="tablist">${wn.map(t)}</nav>`;
	}
	_renderBody(e) {
